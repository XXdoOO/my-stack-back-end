...
insert into blog(title, description, content, up, star, views, author_username, post_time)
values ('如何用 CSS 中写出超级美丽的阴影效果',
        '「这是我参与11月更文挑战的第7天，活动详情查看：2021最后一次更文挑战」。 在我看来，最好的网站和Web应用程序对它们具有切实的"真实"质量。实现这种质量涉及很多因素，但阴影是一个关键因素。 然而', '暂时为空',
        1113, 39, 863077, '非优秀程序员', '2021-11-25 18:03:46'),
       ('【1 月最新】前端 100 问：能搞懂 80% 的请把简历给我',
        ...
        '暂时为空', 18269, 345, 580902, '程序员依扬', '2021-05-12 07:17:12'),
       ('中高级前端大厂面试秘籍，为你保驾护航金三银四，直通大厂(上)',
        ...
        '暂时为空', 11350, 488, 622088, '郭东东', '2020-09-23 15:42:28'),
       ('30 道 Vue 面试题，内含详细讲解（涵盖入门到精通，自测 Vue 掌握程度）',
        ...
        '暂时为空', 14912, 251, 565077, '我是你的超级英雄', '2020-09-14 12:33:51'),
       ('🔥 连八股文都不懂还指望在前端混下去么', '前端八股文还是值得深入了解，系统巩固的基础。扎实的基本功还有利于跳槽涨薪的。小知识，大挑战！努力行动起来吧！', '暂时为空', 25521, 510, 470306,
        'Gaby', '2022-06-08 10:43:45'),
       ('你会用ES6，那倒是用啊！',
        '不是标题党，这是一位leader在一次代码评审会对小组成员发出的“怒吼”，原因是在代码评审中发现很多地方还是采用ES5的写法，也不是说用ES5写法不行，会有BUG，只是造成代码量增多，可读性变差而已。', '暂时为空',
        12737, 1389, 343028, '红尘炼心', '2021-11-08 18:03:04'),
       ('一个合格(优秀)的前端都应该阅读这些文章',
        ...
        '暂时为空', 17476, 388, 336800, 'Neal_yang', '2020-09-13 20:29:44'),
       ('做了一份前端面试复习计划，保熟～',
        '前言 以前我在掘金上看到面试贴就直接刷掉的，从不会多看一眼，直到去年 9 月份我开始准备面试时，才发现很多面试经验贴特别有用，看这些帖子（我不敢称之为文章，怕被杠）的过程中对我的复习思维形成影响很大，', '暂时为空',
        17748, 357, 339367, 'vortesnail', '2022-02-22 22:50:05'),
       ('写给初中级前端的高级进阶指南', '我曾经一度很迷茫，在学了 Vue、React 的实战开发和应用以后，好像遇到了一些瓶颈，不知道该怎样继续深入下去。相信这也是很多一两年经验的前端工程师所遇到共同问题，', '暂时为空',
        14188, 340, 317644, 'ssh_晨曦时梦见兮', '2021-09-30 11:47:39'),
       ('这一次，彻底弄懂 JavaScript 执行机制',
        ...
        '暂时为空', 7526, 811, 287311, 'ssssyoki', '2020-10-31 23:05:48'),
       ('「2021」高频前端面试题汇总之JavaScript篇（上）', '2021 高频前端面试题汇总之JavaScript篇，前端面试题汇总系列文章的JavaScript篇，长期更新，欢迎收藏、点赞！', '暂时为空',
        5641, 96, 374015, 'CUGGZ', '2022-08-22 19:41:40'),
       ('一名【合格】前端工程师的自检清单',
       ...
       ('面试分享：两年工作经验成功面试阿里P6总结',
        ...
        '暂时为空', 6257, 444, 294129, '子弈', '2020-09-14 15:24:28'),
       ('2018前端面试总结，看完弄懂，工资少说加3K | 掘金技术征文',
        ...
        '暂时为空', 5855, 140, 262322, '信心', '2020-09-09 09:46:25'),
       ('字节跳动面试官：请你实现一个大文件上传和断点续传', '这段时间面试官都挺忙的，频频出现在博客文章标题，虽然我不是特别想蹭热度，但是实在想不到好的标题了-。-，蹭蹭就蹭蹭 :)', '暂时为空', 7759, 575,
        250394, 'yeyan1996', '2022-05-14 15:56:40'),
       ('由浅入深，66条JavaScript面试知识点',
        ...
        '暂时为空', 8745, 205, 266653, 'JakeZhang', '2020-09-02 17:20:45'),
       ('一个合格的中级前端工程师需要掌握的 28 个 JavaScript 技巧',
        '2. 循环实现数组 map 方法 3. 使用 reduce 实现数组 map 方法 4. 循环实现数组 filter 方法 5. 使用 reduce 实现数组 filter 方法 6. 循环实现数组的', '暂时为空',
        8635, 323, 250682, 'yeyan1996', '2022-06-26 20:50:14'),
       ('1.5万字概括ES6全部特性(已更新ES2020)',
        ...
        '暂时为空', 10123, 233, 218434, 'JowayYoung', '2021-02-25 15:30:42'),
       ('vue中Axios的封装和API接口的管理',
        ...
        '暂时为空', 5747, 335, 233422, '愣锤', '2020-09-08 19:28:26');